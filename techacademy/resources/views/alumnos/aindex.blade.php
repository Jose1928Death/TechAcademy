...
<a href="{{route('alumnos.create')}}"
    ...
    <div class="py-2 text-right ">
        <form name="search" action="{{route('alumnos.index')}}">
            ...
            <span class="font-bold text-green-700 mx-2">Apellidos:</span>
...
<div class="text-center grid grid-cols-5 py-2 gap-2 mt-10 border-2 border-green-200 shadow">
...
<div class="text-center grid grid-cols-5 py-2 gap-2 mt-10 border-2 border-green-200 shadow py-5">
    ...
    <div>
        <form name="a" action="{{route('alumnos.destroy', $item)}}" method='POST' class="form-inline">
            @csrf
            @method("DELETE")
            <a href="{{route('alumnos.edit', $item)}}" class="bg-yellow-400 hover:bg-green-200 rounded text-white font-bold py-2 px-4 shadow"><i class="fa fa-edit"></i> Editar</a>
            <button type="submit" class="bg-red-400 hover:bg-green-200 rounded text-white font-bold py-2 px-4 shadow" onclick="return confirm('¿Borrar Alumno?')">
